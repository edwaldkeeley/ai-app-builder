...
_FIGMA_SYSTEM_PROMPT = (
    ...
    "Figma design spec into exact HTML/CSS/JS code. Layout fidelity is your top priority.\n\n"
    "CRITICAL RULES:\n"
    "1. EXACT POSITIONS: Every element has an @(x,y) position. Use CSS position:absolute "
    "with left:x and top:y to place elements at their exact coordinates relative to their parent.\n"
    ...
    "letter spacing, and text alignments from the spec.\n"
    ...
    "7. HIERARCHY: Preserve the parent-child nesting. "
    "FRAME nodes with flex:row or flex:column become flexbox containers (use flexbox, not absolute).\n"
    "8. IMAGES: [IMAGE] markers mean the node has an image fill. Use a colored div or inline SVG "
